...
public class DigTest{
	public static void main(String[] args){
		...
		int f[] = {0, 0, 2, 2, 3, 5, 0, 6, 7, 8, 6, 9, 9, 9, 11};
		int t[] = {1, 5, 0, 3, 5, 4, 6, 4, 6, 7, 9, 10, 12, 11, 12};
		AdjacencyListDigraph gl = new AdjacencyListDigraph(13, 15, f, t);

		System.out.println(gl.toString());
		DirectedCycle d = new DirectedCycle(gl);
		DepthFirstOrder dfo = new DepthFirstOrder(gl);
		Topological top = new Topological(gl);
		if(d.hasCycle()){
			for(int i: d.cycle()){
				System.out.print(i + " ");
			}
		...
		System.out.println();
		System.out.println("is DAG: " + top.isDAG());
